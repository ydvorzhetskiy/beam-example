...
java -cp target/beam-example.jar com.dxc.poc.beam.PubSubToBqApplication --project=sabre-cdw-dev-sandbox --region=us-central1 --inputTopic=beam-example-topic --dataset=beam_example --gcpTempLocation=gs://cdm-apache-beam-example/temp --stagingLocation=gs://cdm-apache-beam-example/staging --runner=org.apache.beam.runners.dataflow.DataflowRunner
```
